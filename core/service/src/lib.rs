...
/// Substrate service.
pub struct NewService<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> {
	client: Arc<TCl>,
...
macro_rules! new_impl {
	(
		...
		// Use bounded channel to ensure back-pressure. Authority discovery is triggering one event per authority within
		// the current authority set. This estimates the authority set size to be somewhere below 10 000 thereby setting
		// the channel buffer size to 10 000.
...
impl<TCfg, TBl, TBackend, TExec, TRtApi, TSc, TNetSpec, TExPoolApi, TOc, TAId> AbstractService for
	NewService<TCfg, TBl, Client<TBackend, TExec, TBl, TRtApi>, TSc, NetworkStatus<TBl>,
		NetworkService<TBl, TNetSpec, H256>, TransactionPool<TExPoolApi>, TOc, TAId>
...
impl<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> Future for
NewService<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> {
	type Item = ();
	type Error = Error;
...
impl<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> Executor<Box<dyn Future<Item = (), Error = ()> + Send>> for
NewService<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> {
	fn execute(
		&self,
		future: Box<dyn Future<Item = (), Error = ()> + Send>
...
impl<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> Drop for
NewService<TCfg, TBl, TCl, TSc, TNetStatus, TNet, TTxPool, TOc, TAId> {
	fn drop(&mut self) {
