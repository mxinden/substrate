...
impl<'a> ::std::default::Default for &'a SignedAuthorityAddresses {
    fn default() -> &'a SignedAuthorityAddresses {
        <SignedAuthorityAddresses as ::protobuf::Message>::default_instance()
    }
}

impl SignedAuthorityAddresses {
    pub fn new() -> SignedAuthorityAddresses {
    ...
    pub fn set_addresses(&mut self, v: ::std::vec::Vec<u8>) {
        self.addresses = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_addresses(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.addresses
    }

    // Take field
    pub fn take_addresses(&mut self) -> ::std::vec::Vec<u8> {
...
impl ::protobuf::Message for SignedAuthorityAddresses {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.addresses)?;
                },
                2 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.addresses.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.addresses);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if !self.addresses.is_empty() {
            os.write_bytes(1, &self.addresses)?;
        }
        if !self.signature.is_empty() {
    ...
    fn new() -> SignedAuthorityAddresses {
        SignedAuthorityAddresses::new()
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "addresses",
                    |m: &SignedAuthorityAddresses| { &m.addresses },
                    |m: &mut SignedAuthorityAddresses| { &mut m.addresses },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "signature",
                    |m: &SignedAuthorityAddresses| { &m.signature },
                    |m: &mut SignedAuthorityAddresses| { &mut m.signature },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<SignedAuthorityAddresses>(
                    "SignedAuthorityAddresses",
                    fields,
    ...
    fn default_instance() -> &'static SignedAuthorityAddresses {
        static mut instance: ::protobuf::lazy::Lazy<SignedAuthorityAddresses> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const SignedAuthorityAddresses,
        };
        unsafe {
            instance.get(SignedAuthorityAddresses::new)
        }
    }
}

impl ::protobuf::Clear for SignedAuthorityAddresses {
    fn clear(&mut self) {
        self.addresses.clear();
        self.signature.clear();
...
impl ::std::fmt::Debug for SignedAuthorityAddresses {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SignedAuthorityAddresses {
